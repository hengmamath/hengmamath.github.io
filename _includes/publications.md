<h2 id="publications" style="margin: 2px 0px -15px;">Papers (in reversed chronological order)</h2>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    {% if link.image %} 
  <img src="{{ link.image }}" class="teaser img-fluid z-depth-1" style="width: 600px; height: auto;">
    {% endif %}
  </div>
